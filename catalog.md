...
Reviewed or at least source-checked entries. Ratings are deliberately omitted for now; this library is still in the collection phase.
...
For the current photo-based transformation skills, a useful first-pass continuum is:
...
This is only a routing aid, not a quality ranking.
